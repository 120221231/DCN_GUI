...
describe('index.html', () => {
  ...
  it('Should render all screen elements', () => {
    ...
    expect(container.querySelector('input')).not.toBeNull()
    expect(getByText(container, 'Connection')).toBeInTheDocument()
    expect(container.querySelector('input')).not.toBeNull()
    ...
    expect(container.querySelector('th')).not.toBeNull()
    expect(getByText(container, 'Round Trip Time(ms)')).toBeInTheDocument()
    expect(container.querySelector('th')).not.toBeNull()
    expect(getByText(container, 'Server')).toBeInTheDocument()
    expect(container.querySelector('th')).not.toBeNull()
